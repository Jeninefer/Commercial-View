...
def process_portfolio(records=48853, validate=False, spanish_support=True, usd_factoring=True):
    """
...
def main():
    ...
    parser.add_argument('--records', type=int, default=48853, 
                       help='Number of records to process')
    parser.add_argument('--validate', action='store_true', 
                       help='Enable validation mode')
    parser.add_argument('--spanish-support', action='store_true', default=True,
                       help='Enable Spanish client processing')
    parser.add_argument('--usd-factoring', action='store_true', default=True,
