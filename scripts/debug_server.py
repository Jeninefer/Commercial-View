...
def start_debug_server(port: int = 5678, wait_for_client: bool = True, 
                      api_port: int = 8000, enable_profiling: bool = False) -> None:
    ...
    try:
        ...
        if profiler:
            ...
            profile_file = profile_dir / f"debug_profile_{datetime.now().strftime('%Y%m%d_%H%M%S')}.prof"
