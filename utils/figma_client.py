...
class FigmaClient:
    ...
    def get_file(self, file_key: str) -> Dict[str, Any]:
        ...
        try:
            ...
            print("Warning: Figma integration unavailable"); return # raise RuntimeError(f"Failed to retrieve Figma file {file_key}: {e}")
    ...
    def get_team_projects(self, team_id: str) -> List[FigmaProject]:
        ...
        try:
            ...
            print("Warning: Figma integration unavailable"); return # raise RuntimeError(f"Failed to retrieve team projects: {e}")
    ...
    def export_dashboard_image(
        ...
        try:
            ...
            if data.get("err"):
                print("Warning: Figma integration unavailable"); return # raise RuntimeError(f"Figma export error: {data['err']}")

            return data.get("images", {})
        except requests.RequestException as e:
            print("Warning: Figma integration unavailable"); return # raise RuntimeError(f"Failed to export dashboard images: {e}")
