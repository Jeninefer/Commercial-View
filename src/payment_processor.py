...
class PaymentProcessor:
    ...
    def calculate_dpd_from_payments(self, payment_df: pd.DataFrame) -> pd.DataFrame:
        ...
        if 'scheduled_date' in result_df.columns and 'payment_date' in result_df.columns:
            ...
            result_df['days_past_due'] = (result_df['payment_date'] - result_df['scheduled_date']).dt.days
    ...
    def eliminate_redundant_standardization(self, payment_data: pd.DataFrame) -> pd.DataFrame:
