...
class EnterpriseAnalyticsEngine:
    ...
    def generate_comprehensive_analytics(self) -> Dict[str, Any]:
        ...
        analytics_results["executive_summary"] = self._create_executive_summary(
            analytics_results
        )
    ...
    def _analyze_portfolio_performance(
        ...
        actual_yield = self._calculate_actual_portfolio_yield(
            active_loans, payment_data
        )
        ...
        # Risk distribution
        risk_distribution = (
            active_loans["risk_grade"].value_counts().to_dict()
            if "risk_grade" in active_loans.columns
            else {}
        )
    ...
    def _analyze_risk_metrics(
        ...
        risk_metrics = {
            "credit_risk": self._calculate_credit_risk_metrics(
                loan_data, historic_payments
            ),
    ...
    def _generate_predictive_insights(
        ...
        predictions = {
            "default_probability": self._predict_default_probability(
                loan_data, historic_payments
            ),
