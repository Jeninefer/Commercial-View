...
describe('CommercialViewDashboard', () => {
  ...
  test('displays loading state initially', () => {
    ...
    expect(screen.getByText('Loading Commercial-View Dashboard...')).toBeInTheDocument();
  ...
  test('loads and displays dashboard data successfully', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByText('🏦 Commercial-View Dashboard')).toBeInTheDocument();
    });
  ...
  test('applies correct status colors to KPI cards', async () => {
    ...
    await waitFor(() => {
      const card = screen.getByText('Outstanding Portfolio').closest('.MuiCard-root');
